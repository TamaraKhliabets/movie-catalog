...
function PersonData({ person }) {
  const {
    name, birthday, place_of_birth, deathday, profile_path, biography,
  } = person;
...
PersonData.propTypes = { person: PropTypes.instanceOf(Object) };

PersonData.defaultProps = { person: null };
