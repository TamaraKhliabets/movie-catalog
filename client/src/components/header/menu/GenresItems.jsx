...
export default class GenresItems extends Component {
  componentDidMount() {
    const { genresFetchData } = this.props;
    genresFetchData(`${URL}/genre/movie/list?api_key=${API_KEY}&language=en-US`);
  }

  setGenre = (e) => {
    const {
      setGenre, setDirection, changePage, setOption, setPage,
    } = this.props;
